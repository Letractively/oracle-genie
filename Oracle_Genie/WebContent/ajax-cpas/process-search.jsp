...
<%
	...
	String qry = "SELECT * FROM CPAS_PROCESS WHERE UPPER(NAME) LIKE '%" + key + "%' ORDER BY type, position"; 
...
<%
	String qry2 = "SELECT A.*, (SELECT TYPE FROM CPAS_PROCESS WHERE process=A.process) TYPE FROM CPAS_PROCESS_EVENT A WHERE UPPER(NAME) LIKE '%" + key + "%' ORDER BY process, position"; 
