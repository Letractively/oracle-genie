...
//System.out.println(qry1);
	...
	public void compareView() {
		...
		if (incl != null && !incl.equals("")) qry1 += " and view_name like '%" + incl.toUpperCase() + "%'";
		if (excl != null && !excl.equals("")) qry1 += " and view_name not like '%" + excl.toUpperCase() + "%'";
	...
	public void compareProgram() {
		...
		if (incl != null && !incl.equals("")) qry1 += " and OBJECT_NAME like '%" + incl.toUpperCase() + "%'";
		if (excl != null && !excl.equals("")) qry1 += " and OBJECT_NAME not like '%" + excl.toUpperCase() + "%'";
		...
		addProgress("Schema 1 has " + t1.size() + " objects, Schema 2 has " + t2.size() + " objects.");
